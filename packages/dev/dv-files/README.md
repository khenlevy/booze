...
This package provides a clean, reusable API for file and directory synchronization via rsync. It's used by other Buydy development tools like `dv-cd` for deployment automation.

## Features

- File synchronization to remote servers
- Directory synchronization with optional delete
- Progress reporting
- Compression support
- Exclude patterns
